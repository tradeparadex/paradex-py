...
my_logger.info(f"Markets: {markets}")
...
for market in markets:
    ...
    my_logger.info(f"{symbol} Orders: {orders}")
...
my_logger.info(f"Buy Order Response: {response}")
