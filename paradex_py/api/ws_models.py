...
def create_subscription_request(channel: str, request_id: str | int | None = None) -> str:
    ...
    request = JSONRPCRequest(method="subscribe", params={"channel": channel}, request_id=request_id)
...
def create_auth_request(jwt_token: str, request_id: str | int | None = None) -> str:
    ...
    request = JSONRPCRequest(method="auth", params={"bearer": jwt_token}, request_id=request_id)
...
def create_success_response(request_id: str | int, result: Any) -> str:
    ...
    response = JSONRPCResponse(response_id=request_id, result=result)
...
def create_error_response(request_id: str | int, code: int, message: str) -> str:
    ...
    response = JSONRPCResponse(response_id=request_id, error={"code": code, "message": message})
